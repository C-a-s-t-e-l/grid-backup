...
function openStoryModal(story) {
    ...
    modalLocation.textContent = `Location: ${story.location_name || 'Unknown Location'}`;
    
    // Clear previous story text before adding new paragraphs
    modalFullStory.innerHTML = '';
    
    const fullStoryText = story.full_story || '';
