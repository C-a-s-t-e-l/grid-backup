...
// Add these new functions to both client.js and archive.js
...
function populateModal(storyId) {
    ...
    // --- Existing setup code (all correct) ---
    ...
    //    The double backslash in the regex is crucial.
    const cleanStoryText = storyData.full_story.replace(/\\n/g, '\n');

    // 2. Split the cleaned text into an array of paragraphs.
    ...
    // 4. Create a <p> element for each paragraph and append it.
    //    This method works perfectly with your existing CSS for .story-text-container p
    ...
    // --- Resume with the rest of your function ---
   ...
   function handleSortAndFilter() {
    ...
    if (searchTerm) {
        filteredStories = filteredStories.filter(story => 
            ...
            // Change story.authorNickname to story.nickname
            (story.nickname && story.nickname.toLowerCase().includes(searchTerm)) ||
            // Change story.locationName to story.location_name
